...
exports.run = async (client, message, args) => {
    ...
    // Optional:
    if (amount < 200) return message.channel.send("You don't have enough money for flip. The minimum was $200.");
    ...
    if (lastGamble !== null && cooldown - (Date.now() - lastGamble) > 0) {
        ...
        return message.channel.send(`Wooo that is too fast. You need to wait **${second}** second(s) before you can flip again.`);
    }
